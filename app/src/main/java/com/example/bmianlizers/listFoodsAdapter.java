...
public class listFoodsAdapter extends RecyclerView.Adapter<listFoodsAdapter.ViewHolder> {
    ...
    private List<com.example.bmianlizers.Foods> foodsList;
    FirebaseFirestore firebaseFirestore;
    private static ClickListener listener;

    public listFoodsAdapter(Context context, List<com.example.bmianlizers.Foods> results) {
                ...
                firebaseFirestore.collection("food").document(foodsList.get(positions).getdIDFoods()).delete().
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if(task.isSuccessful()){
                         ...
                         context.startActivity(new Intent(context , com.example.bmianlizers.activityListFood.class).setFlags(Intent.FLAG_ACTIVITY_NEW_TASK));
                        }
                    }
                });
            }
    ...
    public interface ClickListener {
        void onClick(com.example.bmianlizers.Foods result);
    }
}
